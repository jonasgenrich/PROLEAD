...
namespace Software{
    ...
    struct SettingsStruct
    {
		...
		bool enableSpeculativeExecutionAwareness; ///< Speculative Execution Awareness
		int maxSeaRecursionDepth; ///< The maximal recursion depth of the Speculative Execution Awareness on a branches
		int numSeaStepsInWrongBranch; ///< The number of instructions in that the Speculative Execution Awareness executes on the mispredicted case
